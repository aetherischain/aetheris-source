...
These are the dependencies currently used by Aetheris. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/aetherisnl
Keybase  - https://keybase.io/team/aetheris/
