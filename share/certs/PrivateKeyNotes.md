...
unlocked to sign the Aetheris-Qt.app bundle.
...
allowing somebody to distribute a Aetheris-Qt.app or aetheris-qt-setup.exe with a valid
...
that the aetheris-qt.exe file inside the installer had not been tampered with.
