 ...
 * between aetherisd, and aetheris-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/aetherischain/aetherischain>";
    const std::string URL_WEBSITE = "<https://aetherischain.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Aetheris Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Aetheris useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Aetheris More version %s\n", FormatFullVersion());
}
