...
#if defined(NDEBUG)
# error "Aetheris cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Aetheris Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("aetheris-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Aetheris also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Aetheris also requires low S in sigs
