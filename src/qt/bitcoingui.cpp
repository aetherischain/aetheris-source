...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aetheris address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aetheris addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aetheris addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Aetheris command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aetheris network", "", count));
}
...
{
    QString strTitle = tr("Aetheris"); // default title
