...
const QString BITCOIN_IPC_PREFIX("aetheris:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/aetheris-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/aetheris-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/aetheris-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click aetheris: links
...
//
// OSX-specific way of handling aetheris: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in aetheris: URIs
...
bool PaymentServer::handleURI(const QString &scheme, const QString &s)
{
    ...
    else
    {
        Q_EMIT message(tr("URI handling"), tr("URI cannot be parsed! This can be caused by an invalid "
                                              "Aetheris address or malformed URI parameters."),
            CClientUIInterface::ICON_WARNING);
    }
