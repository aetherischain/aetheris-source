...
BOOST_AUTO_TEST_CASE(test_addresses)
{
    ...
    std::vector<std::string> pubkey = {"aetheris:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "aetheris:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "aetheris:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {"aetheris:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "aetheris:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "aetheris:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
