...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"aetherisaddress\"\n"
            "\nReveals the private key corresponding to 'aetherisaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"aetherisaddress\"   (string, required) The aetheris address for the private key\n"
            "\nResult:\n"
